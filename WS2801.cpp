...
void
WS2801::setPixelColor (uint16_t n, uint8_t r, uint8_t g, uint8_t b)
{
  uint32_t data;
...
void
WS2801::setPixelColor (uint16_t n, uint32_t c)
{
  if (n > numLEDs)
    return;
  if (n < 0)
...
//---
uint16_t
WS2801::Translate (uint16_t x, uint16_t y)
{
...
//---
uint32_t
WS2801::Color (uint8_t r, uint8_t g, uint8_t b)
{
  uint32_t data;
...
//=====
void
WS2801::setRange (uint16_t startLED, uint16_t endLED, uint32_t color)
{
...
//-----
void
WS2801::HVLine (int x, int y, int len, int dir, uint32_t color)
{
  if (dir == 0)
    {
...
//---
void
WS2801::line (int x0, int y0, int x1, int y1, uint32_t color)
{
  boolean steep;
...
//=====
void
WS2801::box (int x0, int y0, int x1, int y1, uint32_t color)
{
...
//=====
void
WS2801::boxFill (int x0, int y0, int x1, int y1, uint32_t color)
{
...
//=====
void
WS2801::triangle (int x0, int y0, int x1, int y1, int x2, int y2,
		  uint32_t color)
{
...
//=====
void
WS2801::circle (uint16_t x0, uint16_t y0, uint16_t r, uint32_t color)
{
...
void
WS2801::circleHelp (uint16_t x0, uint16_t y0, uint16_t r, uint16_t corner,
		    uint32_t color)
{
  int f = 1 - r;
  int ddF_x = 1;
...
//=====
void
WS2801::comet (int wait, int red, int green, int blue, int tail)
{
  int xx, yy, zz;
...
//=====
void
WS2801::Twinkle (int wait, int repeat)
{
...
//=====
void
WS2801::MoveLinesH (int del, uint32_t col)
{
  int xx;
...
//=====
void
WS2801::MoveLinesRH (int del, uint32_t col)
{
  int xx;
...
//=====
void
WS2801::MoveLinesV (int del, uint32_t col)
{
  int xx;
...
//=====
void
WS2801::MoveLinesRV (int del, uint32_t col)
{
  int xx;
...
//=====
void
WS2801::SpinLine (int del, uint32_t col)
{
  int xx, yy;
