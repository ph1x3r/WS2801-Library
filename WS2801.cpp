...
/*****************************************************************************/
/* Additions made by Keith Howell (kch@kch.net) for manipulating the LED
 ...
 * ported into this library by Keith Howell (kch@kch.net)
 *****************************************************************************/
...
//-----
// kch - initialize with array size
//-----
...
//---
// kch - digitalWrite is way to slow.
...
//---
// kch - create a single color value out of RGB values
...
//=====
// set a linear block of pixels to a color byte (kch)
//=====
...
//=====
// draw a box using the line drawing function (kch)
//=====
...
//=====
// draw dot along strand with fading tail (kch)
//=====
...
//=====
//Set all leds to a random color (kch)
//=====
...
//=====
// Twinkle all lights - argument determines how many cycles (kch)
//=====
...
//=====
//Wipe horizontal lines down the grid (kch)
//=====
...
//=====
//Wipe horizontal lines up the grid (kch)
//=====
...
//=====
//Wipe vertical lines across (left to right) the grid (kch)
//=====
...
//=====
//Wipe vertical lines across (right to left) the grid (kch)
//=====
...
//=====
// Spin a line in the panel (clockwise) (kch)
//=====
...
//=====
// shortcut for erasing all of the pixels at once (kch)
//=====
void WS2801::clear()
{
  setRange(0,numLEDs-1,0);
